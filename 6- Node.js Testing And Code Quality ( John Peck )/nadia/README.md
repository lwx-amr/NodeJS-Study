...
Visit https://editorconfig.org for more details.

This project is using Eslint to detect suspicious code in Javascript files.
visit https://eslint.org/ for more info 
...
## Testing
This project used Mocha and Chai for testing 
Visit https://mochajs.org/ and https://www.chaijs.com/ for more details

```bash
npm test
```

Code coverage generated by Istanbul (NYC)
Check https://istanbul.js.org/ for more details
